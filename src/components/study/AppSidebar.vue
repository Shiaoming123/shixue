...
<style scoped>
.sidebar { --sidebar-icon-size: 18px; --sidebar-row-padding: 10px; width: 232px; min-width: 232px; height: 100%; display: flex; flex-direction: column; padding: 24px 12px 20px; border-right: 1px solid var(--border); background: var(--surface); transition: width var(--motion-base) var(--ease), min-width var(--motion-base) var(--ease), padding var(--motion-base) var(--ease); }
