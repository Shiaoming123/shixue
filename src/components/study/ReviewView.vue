...
.record-tools label { min-height: var(--field-min-height); border-color: transparent; border-radius: var(--radius-md); background: var(--field-fill); transition: background var(--motion-fast) var(--ease), border-color var(--motion-fast) var(--ease), box-shadow var(--motion-fast) var(--ease); }.record-tools label:hover:not(:focus-within) { background: var(--field-hover-fill); }.record-tools label:focus-within { border-color: var(--accent); background: var(--field-focus-fill); box-shadow: var(--field-focus-ring); }
