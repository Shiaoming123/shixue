...
.batch-bar { min-height: 46px; display: flex; align-items: center; justify-content: space-between; margin-top: 10px; padding: 5px 7px 5px 13px; border-radius: var(--radius-lg); background: color-mix(in srgb, var(--accent) 9%, var(--surface)); color: var(--accent); font-size: var(--text-sm); }.batch-bar > div { display: flex; gap: 3px; }.batch-bar button { width: 36px; height: 36px; display: grid; place-items: center; border: 0; border-radius: var(--radius-md); background: transparent; color: inherit; }.task-sections { margin-top: 20px; }.task-section { padding: 20px; border: 1px solid var(--border); border-radius: var(--radius-xl); background: var(--surface); box-shadow: var(--shadow-sm); }.task-section + .task-section { margin-top: 20px; }.task-section h2 { margin: 0 0 7px; color: var(--accent); font-size: var(--text-sm); font-weight: 650; }.task-section h2.overdue { color: var(--danger); }.task-section h2 span { margin-left: 4px; color: var(--muted); font-weight: 500; }
...
@media (max-width: 819px) { .tasks-view { width: 100%; padding: 18px 16px calc(106px + env(safe-area-inset-bottom, 0px)); }.page-header h1 { font-size: 21px; }.task-sections { margin-top: 20px; }.task-section { padding: 12px; }.task-row { min-height: 68px; }.task-main { min-height: 67px; grid-template-columns: minmax(0, 1fr) 22px; }.chevron { display: none; }.task-copy strong { white-space: normal; }.task-copy small { gap: 9px; }.task-copy small span:nth-child(2) { display: none; }.row-actions { display: none !important; }.filters { grid-template-columns: 1fr; }.complete-button span { width: 24px; height: 24px; } }
