  ...
  <section class="tasks-view">
    <PageHeader :title="title" :subtitle="subtitle" variant="large">
      <template #actions><div class="header-actions">
        ...
        <IconButton aria-label="筛选" :class="{ active: toolbarOpen }" @click="toolbarOpen = !toolbarOpen"><Filter :size="18" /></IconButton>
    ...
    />
    <label class="search-field"><Search :size="16" /><input ref="searchInput" v-model="searchModel" type="search" aria-label="搜索任务" placeholder="搜索" /><IconButton v-if="searchModel" aria-label="清除搜索" size="sm" @click="searchModel = ''"><X :size="14" /></IconButton><kbd v-else>/</kbd></label>
