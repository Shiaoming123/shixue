...
.create-row { margin-top: 20px; }.create-row > label { display: block; margin-bottom: 7px; color: var(--muted); font-size: var(--text-xs); font-weight: 600; }.create-row > div { display: grid; grid-template-columns: 1fr auto; gap: 9px; }.create-row input, .rename-row input { min-width: 0; min-height: 44px; padding: 9px 12px; border: 1px solid var(--hairline); border-radius: var(--radius-lg); outline: 0; background: var(--control-fill); color: var(--text); font: inherit; }.create-row input:focus, .rename-row input:focus { border-color: var(--accent); background: var(--surface); box-shadow: var(--focus-ring); }.create-row button { min-height: 44px; display: inline-flex; align-items: center; justify-content: center; gap: 6px; padding: 0 15px; border: 0; border-radius: var(--radius-lg); background: var(--accent); color: var(--accent-text); font: inherit; font-size: var(--text-xs); font-weight: 650; }.create-row button:disabled { opacity: .42; }
