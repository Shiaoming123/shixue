...
.date-trigger { width: 100%; min-height: var(--field-min-height); display: grid; grid-template-columns: minmax(0, 1fr) 18px; align-items: center; gap: var(--space-2); padding: 0 var(--space-3); border: 1px solid transparent; border-radius: var(--radius-md); background: var(--field-fill); color: var(--text); font-size: var(--text-base); font-variant-numeric: tabular-nums; text-align: left; }.date-trigger.placeholder { color: var(--muted); }.date-trigger:hover:not([aria-expanded='true']) { background: var(--field-hover-fill); }.date-trigger[aria-expanded='true'] { border-color: var(--accent); background: var(--field-focus-fill); box-shadow: var(--field-focus-ring); }.date-trigger > i { position: relative; width: 15px; height: 15px; justify-self: end; border: 1.5px solid currentColor; border-radius: 4px; color: var(--muted); }.date-trigger > i::before { content: ''; position: absolute; top: 3px; left: -1.5px; right: -1.5px; border-top: 1.5px solid currentColor; }
.date-panel { width: min(340px, calc(100vw - 16px)); padding: var(--space-3); font-variant-numeric: tabular-nums; }.time-field { display: grid; grid-template-columns: 1fr 88px; align-items: center; gap: var(--space-3); margin-top: var(--space-3); padding-top: var(--space-3); border-top: 1px solid var(--hairline); }.time-field span { color: var(--muted); font-size: var(--text-sm); }.time-field input { min-height: var(--field-min-height); padding: 0 var(--space-2); border: 1px solid transparent; border-radius: var(--radius-md); outline: 0; background: var(--field-fill); color: var(--text); font-size: var(--text-base); font-variant-numeric: tabular-nums; text-align: center; }.time-field input:focus { border-color: var(--accent); background: var(--field-focus-fill); box-shadow: var(--field-focus-ring); }.timezone-note { margin: var(--space-1) 0 0; color: var(--muted); font-size: var(--text-xs); text-align: right; }.date-panel footer { display: flex; justify-content: flex-end; gap: var(--space-2); margin-top: var(--space-3); }.date-panel footer button { min-height: max(36px, var(--control-hit)); padding: 0 var(--space-3); border: 1px solid var(--hairline); border-radius: var(--radius-md); background: var(--control-fill); color: var(--text); font-size: var(--text-sm); }.date-panel footer .apply { border-color: transparent; background: var(--accent); color: var(--accent-text); }.date-panel footer .apply:disabled { opacity: .42; }
