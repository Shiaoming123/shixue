...
.date-panel { width: min(320px, calc(100vw - 16px)); padding: var(--space-3); font-variant-numeric: tabular-nums; }.date-shortcuts { display: flex; gap: var(--space-1); }.date-shortcuts button { min-height: 32px; padding: 0 var(--space-3); border: 0; border-radius: var(--radius-md); background: var(--control-fill); color: var(--text); font-size: var(--text-xs); }.date-shortcuts .clear { margin-left: auto; color: var(--danger); }.month-header { display: grid; grid-template-columns: 36px 1fr 36px; align-items: center; gap: var(--space-2); margin-top: var(--space-3); }.month-header strong { text-align: center; font-size: var(--text-base); font-weight: 600; }.month-header button { width: 36px; height: 36px; border: 0; border-radius: var(--radius-md); background: transparent; color: var(--muted); font-size: var(--text-xl); }.month-header button:hover { background: var(--control-fill); color: var(--text); }
...
.time-field { display: grid; grid-template-columns: 1fr 88px; align-items: center; gap: var(--space-3); margin-top: var(--space-3); padding-top: var(--space-3); border-top: 1px solid var(--hairline); }.time-field span { color: var(--muted); font-size: var(--text-sm); }.time-field input { min-height: 38px; padding: 0 var(--space-2); border: 1px solid var(--hairline); border-radius: var(--radius-md); outline: 0; background: var(--control-fill); color: var(--text); font-size: var(--text-base); font-variant-numeric: tabular-nums; text-align: center; }.time-field input:focus { border-color: var(--accent); box-shadow: var(--focus-ring); }.timezone-note { margin: var(--space-1) 0 0; color: var(--muted); font-size: var(--text-xs); text-align: right; }.date-panel footer { display: flex; justify-content: flex-end; gap: var(--space-2); margin-top: var(--space-3); }.date-panel footer button { min-height: 36px; padding: 0 var(--space-3); border: 1px solid var(--hairline); border-radius: var(--radius-md); background: var(--control-fill); color: var(--text); font-size: var(--text-sm); }.date-panel footer .apply { border-color: transparent; background: var(--accent); color: var(--accent-text); }.date-panel footer .apply:disabled { opacity: .42; }
</style>
