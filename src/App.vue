...
async function runUpdateCheck() {
  if (!updaterAvailable.value || ['checking', 'downloading', 'installing'].includes(updateState.value.phase)) return
