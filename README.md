...
- **可选学习模式**：为任务增加主题、专注会话、完成标准、成果证据和 1 / 3 / 7 天复习；“节律”按真实重复实例与完成证据派生本周进度，“回顾”按主题汇总本周计划现状、完成证据覆盖、本周到期复习、有证据完成、关联专注分钟和实际完成复习，并可下钻到原任务、发生项或完成记录。两者都不建立新的统计或空打卡事实。普通待办即使经过专注会话也只完成任务与会话，不生成学习完成记录或复习计划。
